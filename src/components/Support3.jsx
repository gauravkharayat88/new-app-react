    ...
    <div className='active-tckts'>
      ...
      <Link to="/Activetickets" style={{textDecoration:'none'}}>
        ...
        <p className='gnrte'>Generate New Ticket</p></Link>
             <div className='active-tckts-012'>
        <Link to="/Support3" style={{textDecoration:'none'}}>
        <p className='gnrte'>All Tickets</p></Link></div>
        </div>
        </div>
        <div className='sign-000'>
        <div className='card-30'>
        
            <div className='booking-detail-back'>
                    <div className='sign'>
                <p className='Ticket'>Ticket ID</p>
                <p className='Train'>Train</p>
                <p className='Booking-ID'>Booking ID</p>
                <p className='Train'>Date</p>
                  ...
                  <div className='booking-detail-back-00'>
                    <div className='sign'>
                <p className='Ticket-1'>1D4FGH</p>
                <p className='Train-1'>Maharaja’s Express</p>
                <p className='Booking-ID-1'>MHE12332JDI001</p>
                <p className='Train-11'>25 JULY 2022</p>
            ...
            <div className='booking-detail-back-00'>
                    <div className='sign'>
                <p className='Ticket-11'>1D4FGH</p>
                <p className='Train-111'>Maharaja’s Express</p>
                <p className='Booking-ID-11'>MHE12332JDI001</p>
                <p className='Train-101'>25 JULY 2022</p>
